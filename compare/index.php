...
<div class="container mt-5">
    ...
    <table class="table">
        ...
        <tbody>
            ...
            // Consulta SQL para obtener registros diferentes con nombre_completo
            $sql = "SELECT members.numero_de_empleado, members.nombre_completo
                    FROM members
                    LEFT JOIN empleados ON members.numero_de_empleado = empleados.empleado
                    WHERE empleados.empleado IS NULL";
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    echo '<tr>';
                    echo '<td>' . $row['numero_de_empleado'] . '</td>';
...
<?php
    ...
    // Obtener el total de registros en la tabla "members"
    ...
    $percentage = ($totalResult / $totalMembers) * 100;

    echo '<p>Total de registros analizados: ' . $totalMembers . '</p>';
